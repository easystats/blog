...
Many times, for instance when teaching, I needed to quickly and simply generate a perfectly **perfectly normally distributed sample** to illustrate or show some of its characteristics.
...
We can also easily color some of the parts of the curve, for instance, the observations lying beyond +2 standard deviation.
