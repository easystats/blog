...
```{r dataframe}
posterior_samples <- as.data.frame(as.matrix(as.mcmc.emmGrid(c_color_all, names = FALSE)))
prior_samples <- as.data.frame(as.matrix(as.mcmc.emmGrid(prior_c_color_all, names = FALSE)))
