...
report(aov_results)
```
```{r, fig.width=7, fig.height=4.5, eval = FALSE, results='markup', fig.align='center', comment=NA, message=FALSE, warning=FALSE, echo=FALSE}
...
aov_results %>% 
  ...
  to_table()
```
```{r eval = FALSE, echo=FALSE, fig.align='center', fig.height=4.5, fig.width=7, message=FALSE, warning=FALSE, comment=NA, results='asis'}
aov_results %>% 
  report() %>% 
  to_table() %>% 
