...
The primary goal is to provide utilities for processing the parameters of various statistical models. It is useful for end-users as well as developpers, as it is a lightweight and open-developed package.
