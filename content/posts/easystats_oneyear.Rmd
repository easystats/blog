...
About a year ago, I (Dominique Makowski) sadly realised that the R package I was maintaining ([*psycho*](https://github.com/neuropsychology/psycho.R)) was drifting more and more away from its original scope, getting drown under a pile of unrelated and under-documented features that I kept on adding as my R skills improved. **Something had to be done.**
...
And yet, although fun is good, it doesn't make for a living (unless you're Mr Bean). And the **easystats** project can also be considered as a legit academic research project with legit academic outcomes. This year, we published **3 papers** related to easystats, and we plan on keeping up *at least* that rhythm for the year to come *(now might be your chance to get involved ;)*. Here are the packages with accompanying papers, all published in the *Journal of Open Source Software*: 

1. [insight](https://joss.theoj.org/papers/10.21105/joss.01412)
2. [bayestestR](https://joss.theoj.org/papers/10.21105/joss.01541)
3. **OTHER PAPER HERE...**
