...
Maybe something like that, but then you have to account for **all the edgecases** and so on. And trust us, **that's a lot of work** to have a robust and bug-free solution.
