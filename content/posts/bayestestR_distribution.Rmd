...
Thus, after discussion, we decided to change it to `distribution_normal` (INSERT LINK). And guess what, we also used that opportunity to add other types of "perfect" distributions:
