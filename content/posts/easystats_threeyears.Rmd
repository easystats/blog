...
This project is now approaching a stage where we can start thinking about finally publishing the meta-package *easystats* on CRAN, which will give users a single entry point to access the entire ecosystem's functionality. It won't be easy though, as CRAN typically doesn't like this type of meta packages, but we have already some ideas to make it work.
